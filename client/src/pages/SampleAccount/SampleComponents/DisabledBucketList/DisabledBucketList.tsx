...
import "./DisabledBucketList.css";

const DisabledBucketList = ({
  bucketList,
  setArrayObject,
  setEditMode,
  contributorObjects,
  ...
  return (
    <div className="disabled-bucket-list-wrapper">
      {bucketList.privacy_type === "public_random" && (
        <div
          onClick={handleCopy}
          className="disabled-bucket-list-public-share-button"
        >
          <h2>Share</h2>
      ...
      {userID === bucketList.owner_id ? (
        <div
          onClick={handleBucketListEdit}
          className="disabled-bucket-list-edit-button"
        >
          <h2>Edit</h2>
        </div>
      ) : (
        <h3 className="disabled-bucket-list-owner-text">
          Owned by{" "}
          {
            friends?.filter(
      ...
      {bucketList.privacy_type === "public_random" ? (
        <div className="disabled-bucket-list-privacy-type">
        ...
        <div
          ...
          className="disabled-bucket-list-privacy-type-shared"
        >
          <h4>View shared users</h4>
          {/* view shared users overlay */}
          {viewState && (
            <div className="disabled-bucket-list-shared-users-overlay">
      ...
      <div className="disabled-bucket-list-container">
        <h1 className="disabled-bucket-list-title">{bucketList.title}</h1>
        <p className="disabled-bucket-list-text">
...
export default DisabledBucketList;
